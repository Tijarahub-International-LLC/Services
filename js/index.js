...
const plansContent = {
  ...
  standard: {
    annually: {
      price: "$193",
      services: isEnglishVersion() ? ["", "1 Sales", "1 Time / Year", "8 / Month", true, true, "6 / Month", true, false,"Up to 10M EGP"] : ["", "1 موظف مبيعات", "1 مرة / سنة", "8 / شهر", true, true, "6 / شهر", true, false,"الي 10 ملايين ج. م."],
    ...
    monthly: {
      price: "$275",
      services: isEnglishVersion() ? ["", false, "With Cost", "5 / Month", true, true, "5 / Month", true, false,"Up to 10M EGP"] : ["", false, "مع تكلفة", "5 / شهريا", true, true, "5 / شهريا", true, false,"الي 10 ملايين ج. م."],
  ...
  premium: {
    annually: {
      price: "$320",
      services: isEnglishVersion() ? ["", "2 Sales", "2 Time / Year", "15 / Month", true, true, "12 / Month", true, true,"Up to 10M EGP"] : ["", "2 مبيعات", "2 مرة / سنة", "15 / شهريا", true, true, "12 / شهريا", true, true,"الي 10 ملايين ج. م."],
    ...
    monthly: {
      price: "$460",
      services: isEnglishVersion() ? ["", "1 Sales", "With Cost", "12 / Month", true, true, "10 / Month", true, true,"Up to 10M EGP"] : ["", "1 مبيعات", "مع تكلفة", "12 / شهريا", true, true, "10 / شهريا", true, true,"الي 10 ملايين ج. م."],
